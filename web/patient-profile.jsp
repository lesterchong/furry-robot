...
<html>
    ...
    <body class="grey lighten-4">
        ...
        <%
            ...
            PatientModel patientModel = patientDAO.getPatientByID(Integer.parseInt(request.getParameter("patient")));;
        %>
        <!-- nav bar -->
                ...
                <div class="col s12">
                    <div class="card hoverable">
                        ...
                        <div class="card-action red accent-1 white-text">
                            <div class="right">
                                <a href="PendingPatientTransferServlet?patient=<%out.print(patientModel.getPatientID());%>" class="white-text">Transfer</a>
