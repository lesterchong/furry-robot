...
public class AddSupplyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            model.setSupplyName(request.getParameter("supplyName"));
            model.setAmount(Integer.parseInt(request.getParameter("supplyAmount")));
            model.setHospital(request.getParameter("hospital"));
            
            if(dao.addSupply(model)){
