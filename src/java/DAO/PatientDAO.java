...
public class PatientDAO {
    ...
    private ConnectionFactory cf;
        ...
        try{
            ...
            ps = con.prepareStatement("UPDATE patient SET tourniquet=?, platelets=?, cbc=?, ast=?, wbc=?, alt=?, hemocrit=?, hemoglobin=?, dateTaken2=? WHERE patientID = ?");
            ps.setBoolean(1, model.getPatientProcedure().isTourniquet());
            ps.setBoolean(2, model.getPatientProcedure().isPlatelets());
            ps.setBoolean(3, model.getPatientProcedure().isCbc());
            ps.setBoolean(4, model.getPatientProcedure().isAst());
            ps.setBoolean(5, model.getPatientProcedure().isWbc());
            ps.setBoolean(6, model.getPatientProcedure().isAlt());
            ps.setBoolean(7, model.getPatientProcedure().isHemocrit());
            ps.setBoolean(8, model.getPatientProcedure().isHemoglobin());
            ps.setDate(9, model.getPatientProcedure().getDateTaken());
            ps.setInt(10, model.getPatientID());
            ps.executeUpdate();
            con.close();
            return true;
    ...
    public LinkedList<PatientModel> getPatients(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                procedureModel.setPlatelets(rs.getBoolean("platelets"));
    ...
    public boolean addPatient(PatientModel model){
        ...
        try{
            con = cf.getConnection();
            ps = con.prepareStatement("INSERT INTO patient(patientDiagnosis, patientWard, tourniquet, platelets, cbc, ast, wbc, alt, hemocrit, hemoglobin, staffID) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            ps.setInt(9, 0);
            ps.setInt(10, 0);
            ps.setInt(11, Integer.parseInt(model.getAssignedNurse()));
            ps.executeUpdate();
            con.close();
            return true;
        }catch(SQLException e){
    ...
    public boolean transferProcedureToHistory(PatientModel model){
        ...
        try{
            con = cf.getConnection();
            ps = con.prepareStatement("INSERT INTO history_procedure(alt, ast, cbc, hemocrit, hemoglobin, platelets, tourniquet, wbc, dateTaken, patientID) VALUES(?,?,?,?,?,?,?,?,?,?)");
            ps.setBoolean(1, model.getPatientProcedure().isAlt());
            ps.setBoolean(2, model.getPatientProcedure().isAst());
            ps.setBoolean(3, model.getPatientProcedure().isCbc());
            ps.setBoolean(4, model.getPatientProcedure().isHemocrit());
            ps.setBoolean(5, model.getPatientProcedure().isHemoglobin());
            ps.setBoolean(6, model.getPatientProcedure().isPlatelets());
            ps.setBoolean(7, model.getPatientProcedure().isTourniquet());
            ps.setBoolean(8, model.getPatientProcedure().isWbc());
            ps.setDate(9, model.getPatientProcedure().getDateTaken());
            ps.setInt(10, model.getPatientID());
            ps.executeUpdate();
            con.close();
